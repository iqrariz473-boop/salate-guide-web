...
const LANGUAGE_STORAGE_KEY = "salat-guide-dua-language";

const FAVORITES_STORAGE_KEY = "salat-guide-dua-favorites";

const LAST_READ_DUA_KEY = "salat-guide-last-read-dua";

const VIEWED_CHAPTERS_KEY = "salat-guide-viewed-chapters";
...
function getChapterArabic(chapter) {
  return chapter?.arabic || chapter?.arabic_title || chapter?.arabic_name || "";
}

function getDuaArabic(dua) {
  return dua?.arabic || dua?.arabic_text || dua?.text_ar || "";
}
...
function getDuaTranslation(dua) {
  return (
    dua?.translation || dua?.translation_text || dua?.translated_text || ""
  );
}

function getDuaReference(dua) {
  return dua?.reference || dua?.source || dua?.hadith || "";
}
...
function DuaRow({ chapter, index, isFavorite, onFavorite, onOpen }) {
  const title = getChapterTitle(chapter);
  const arabic = getChapterArabic(chapter);

  return (
    <article className="duas-table__row">
      <div className="duas-table__cell duas-table__cell--id" data-label="No.">
      ...
      >
        <div className="duas-chapter-info">
          ...
          {arabic && (
            <p className="duas-chapter-info__arabic" dir="rtl">
              {arabic}
            </p>
          )}
        </div>
      ...
      >
        <button
          type="button"
          className={`duas-favorite ${isFavorite ? "is-active" : ""}`}
...
function DuaDetailCard({ dua, index, chapterId }) {
  ...
  /* =====================================================
     AUDIO URL
     API gives relative audio path
     Example:
     data/hisnulmuslimaudios/dua006_1.mp3

     .env gives:
     VITE_AUDIO_BASE_URL=https://appslogie.com/
  ===================================================== */
  const audioPath = dua?.url || "";

  const audioBaseUrl = import.meta.env.VITE_AUDIO_BASE_URL || "";

  const audioUrl = audioPath
    ? `${audioBaseUrl.replace(/\/$/, "")}${audioPath}`
    : "";
    ...
    <article className="dua-detail-card">
      ...
      <div className="dua-detail-card__content">
        <div className="dua-detail-card__top">
          <div className="dua-detail-card__badge">Supplication {index + 1}</div>

          {reference && (
            <div className="dua-detail-card__source">Authentic Source</div>
          )}
        </div>
        ...
        {arabic && (
          <div className="dua-detail-card__section dua-detail-card__section--arabic">
            <span className="dua-detail-card__label">Arabic</span>

            <div className="dua-detail-card__arabic-wrap">
              <span className="dua-detail-card__ornament" aria-hidden="true">
                ۞
              </span>

              <p className="dua-detail-card__arabic" dir="rtl">
                {arabic}
              </p>
        ...
        {transliteration && (
          <div className="dua-detail-card__section">
            <span className="dua-detail-card__label">Transliteration</span>
        ...
        {translation && (
          <div className="dua-detail-card__section">
            <span className="dua-detail-card__label">Translation</span>

            <p className="dua-detail-card__translation">{translation}</p>
          </div>
        )}
        ...
        {reference && (
          <div className="dua-detail-card__reference">
            <div className="dua-detail-card__reference-icon">✦</div>
        ...
        <div className="dua-detail-card__audio">
          <div className="dua-detail-card__audio-head">
            <div className="dua-detail-card__audio-icon">♪</div>

            <div>
              <strong>Listen to this Dua</strong>
          ...
          <div className="dua-detail-card__audio-url">Audio ready</div>
        </div>
      </div>
    </article>
  );
...
function DuaCategoryExplorer({ categories, chapters, onSelectCategory }) {
  const categoryIcons = {
    1: "☀",
    2: "⌂",
    3: "◉",
  ...
  return (
    <section className="dua-category-explorer">
      <div className="dua-category-explorer__header">
        <div>
          <span className="dua-section-eyebrow">Explore by Intention</span>

          <h2>Find the Right Dua</h2>

          <p>
            Browse supplications according to different moments and needs of
            life.
          </p>
        </div>
      </div>
      ...
      <div className="dua-category-grid">
        {categories.map((id) => {
          const count = chapters.filter(
            (chapter) => String(chapter?.category_id) === String(id),
          ).length;
          ...
          return (
            ...
            >
              ...
              <span className="dua-category-card__content">
                <strong>{CATEGORY_NAMES[id] || `Category ${id}`}</strong>
              ...
              <span className="dua-category-card__arrow">→</span>
            </button>
          );
        })}
      </div>
...
function DuaJourney({
  ...
  const exploredCount = viewedChapters.filter((id) =>
    chapters.some((chapter) => chapter.id === id),
  ).length;

  const progress =
    totalChapters > 0
      ? Math.min(100, Math.round((exploredCount / totalChapters) * 100))
      : 0;
  ...
  function handleContinue() {
    ...
    const chapter = chapters.find((item) => item.id === lastRead.id);
      ...
      <div className="dua-journey__inner">
        <div className="dua-journey__header">
          <div>
            ...
            <h2>Your Dua Journey</h2>

            <p>
              Keep track of the chapters you have explored and the duas you want
              to revisit.
            </p>
          </div>
        ...
        <div className="dua-journey__progress">
          ...
          <div className="dua-journey__progress-info">
            <span>
              {exploredCount} of {totalChapters} chapters
            </span>
        ...
        <div className="dua-journey__stats">
          <div className="dua-journey__stat">
            <span className="dua-journey__stat-icon">◈</span>
        ...
        {lastRead ? (
          <div className="dua-journey__continue">
            <div className="dua-journey__continue-icon">۞</div>
            ...
            <div className="dua-journey__continue-content">
              ...
              {lastRead.arabic && <p dir="rtl">{lastRead.arabic}</p>}
            </div>

            <button
              type="button"
              onClick={handleContinue}
              disabled={!chapters.some((item) => item.id === lastRead.id)}
            >
              Continue
              <span>→</span>
            </button>
          ...
          <div className="dua-journey__empty">
            ...
            <div>
              <strong>Your reading journey starts here</strong>

              <p>
                Open any chapter above and it will appear here for easy access
                later.
              </p>
            </div>
          </div>
...
function DuaReflection() {
  const reflections = [
    ...
    },
    {
      ...
      text: "And upon Allah rely, if you are believers.",
  ...
  return (
    <section className="dua-reflection">
      <div className="dua-reflection__inner">
        <div className="dua-reflection__icon">۞</div>

        <div className="dua-reflection__content">
          <span>Pause &amp; Reflect</span>

          <h2>A Moment of Remembrance</h2>

          <p className="dua-reflection__arabic" dir="rtl">
            {reflection.arabic}
          </p>

          <p className="dua-reflection__text">{reflection.text}</p>

          <small>{reflection.reference}</small>
        </div>
...
function DuaQuickDashboard({
  ...
  const todayDua = chapters.length > 0 ? chapters[0] : null;

  const morningDua =
    chapters.find((chapter) => String(chapter?.category_id) === "1") ||
    chapters[0];

  const favoriteCount = favorites.length;

  const lastReadExists =
    lastRead && chapters.some((chapter) => chapter.id === lastRead.id);
    ...
    <section className="dua-quick-dashboard">
      <div className="dua-quick-dashboard__inner">
        <div className="dua-quick-dashboard__header">
          <div>
            <span className="dua-section-eyebrow">Your Daily Companion</span>

            <h2>Stay Connected With Your Duas</h2>

            <p>
              Continue your journey, revisit saved chapters, or discover a new
              dua today.
            </p>
          </div>
        </div>
        ...
        <div className="dua-quick-dashboard__grid">
          ...
          <article className="dua-quick-card dua-quick-card--featured">
            <div className="dua-quick-card__top">
              <span className="dua-quick-card__icon">۞</span>

              <span className="dua-quick-card__label">Today's Dua</span>
            </div>

            <h3>
              {todayDua ? getChapterTitle(todayDua) : "Begin Your Dua Journey"}
            </h3>

            <p>A beautiful reminder to keep your heart connected with Allah.</p>

            {todayDua && (
              <button
                type="button"
                className="dua-quick-card__link"
                onClick={() => onContinue(todayDua)}
              >
                Continue reading
                <span>→</span>
              </button>
          ...
          <article className="dua-quick-card">
            <div className="dua-quick-card__top">
              ...
              <span className="dua-quick-card__label">Morning Dua</span>
            </div>

            <h3>
              {morningDua ? getChapterTitle(morningDua) : "Morning & Evening"}
            </h3>

            <p>Start your day with remembrance, gratitude and protection.</p>

            {morningDua && (
              <button
                type="button"
                className="dua-quick-card__link"
                onClick={() => onContinue(morningDua)}
              >
                Read morning duas
                <span>→</span>
              </button>
          ...
          <article className="dua-quick-card">
            <div className="dua-quick-card__top">
              ...
              <span className="dua-quick-card__label">Favorites</span>
            </div>

            <div className="dua-quick-card__stat">{favoriteCount}</div>

            <h3>Saved duas</h3>

            <p>Your favorite chapters are saved for easy access.</p>
          ...
          <article className="dua-quick-card">
            <div className="dua-quick-card__top">
              ...
              <span className="dua-quick-card__label">Last Read</span>
            </div>

            <h3>{lastReadExists ? lastRead.title : "No chapter yet"}</h3>
            ...
            {lastReadExists && (
              <small className="dua-quick-card__time">Just now</small>
            )}
          </article>
          ...
          <article className="dua-quick-card dua-quick-card--streak">
            <div className="dua-quick-card__top">
              ...
              <span className="dua-quick-card__label">Daily Streak</span>
            </div>
          ...
          <article className="dua-quick-card dua-quick-card--random">
            <div className="dua-quick-card__top">
              ...
              <span className="dua-quick-card__label">Random Dua</span>
            </div>

            <h3>Discover Dua</h3>

            <p>Let today bring you a new supplication to reflect upon.</p>
...
function DailyDuaFeature({ duas, language }) {
  const [currentIndex, setCurrentIndex] = useState(0);

  const [copied, setCopied] = useState(false);

  const availableDuas = Array.isArray(duas) ? duas.filter(Boolean) : [];

  const currentDua =
    availableDuas.length > 0
      ? availableDuas[currentIndex % availableDuas.length]
      : null;

  const arabic = currentDua ? getDuaArabic(currentDua) : "";

  const transliteration = currentDua ? getDuaTransliteration(currentDua) : "";

  const translation = currentDua ? getDuaTranslation(currentDua) : "";

  function handleNewDua() {
    if (availableDuas.length <= 1) {
      return;
    }
    ...
    setCurrentIndex((current) => {
      const next = Math.floor(Math.random() * availableDuas.length);

      if (next === current) {
        return (current + 1) % availableDuas.length;
      }
  ...
  async function handleCopy() {
    ...
    const copyText = [arabic, transliteration, translation]
      .filter(Boolean)
      .join("\n\n");
    ...
    <section className="daily-dua-feature">
      ...
      <div className="daily-dua-feature__inner">
        <div className="daily-dua-feature__header">
          <span className="daily-dua-feature__eyebrow">Daily Inspiration</span>

          <h2>A Dua for Your Day</h2>

          <p>
            Take a moment, reflect, and make this beautiful supplication part of
            your day.
          </p>
        </div>
        ...
        <div className="daily-dua-card">
          ...
          <div className="daily-dua-card__content">
            ...
            {translation && (
              <div className="daily-dua-card__translation-block">
                <span>{language === "urdu" ? "ترجمہ" : "Translation"}</span>
            ...
            <div className="daily-dua-card__actions">
              ...
              <button
                ...
                disabled={availableDuas.length <= 1}
              >
                <span>↻</span>
                New Dua
              </button>
        ...
        <div className="daily-dua-feature__footer">
          ...
          <p>Make dua with sincerity and trust in Allah.</p>
...
function DuaFAQ() {
  const faqs = [
    ...
    {
      question: "Does Dua always get answered immediately?",
      answer:
    ...
    {
      question: "What is the difference between Dua and Dhikr?",
      answer:
    ...
    <section className="dua-faq">
      <div className="dua-faq__inner">
        ...
        <div className="dua-faq__header">
          <span className="dua-section-eyebrow">Questions &amp; Guidance</span>

          <h2>Frequently asked questions about Duas</h2>

          <p>
            Find simple answers to common questions about making dua and keeping
            your heart connected with Allah.
          </p>
        </div>
        ...
        <div className="dua-faq__list">
          {faqs.map((faq, index) => {
            ...
            return (
              <article
                key={faq.question}
                className={`dua-faq__item ${isOpen ? "is-open" : ""}`}
              >
                <button
                  type="button"
                ...
                >
                  <span className="dua-faq__question-icon">?</span>

                  <span className="dua-faq__question-text">{faq.question}</span>

                  <span
                    className={`dua-faq__arrow ${isOpen ? "is-open" : ""}`}
                    aria-hidden="true"
                  >
                    +
                  </span>
                ...
                <div className={`dua-faq__answer ${isOpen ? "is-open" : ""}`}>
        ...
        <div className="dua-faq__note">
          <span className="dua-faq__note-icon">۞</span>

          <div>
            <strong>Keep learning, keep making Dua</strong>

            <p>
              May your supplications bring you closer to Allah and fill your
              heart with peace and hope.
            </p>
          </div>
        </div>
      </div>
...
export default function Duas() {
  ...
  const [hasMoreDuas, setHasMoreDuas] = useState(false);

  const [loadingMoreDuas, setLoadingMoreDuas] = useState(false);
  ...
  const [featuredDuas, setFeaturedDuas] = useState([]);
  ...
  const [lastRead, setLastRead] = useState(() => {
    try {
      const saved = localStorage.getItem(LAST_READ_DUA_KEY);
  ...
  const [viewedChapters, setViewedChapters] = useState(() => {
    try {
      const saved = localStorage.getItem(VIEWED_CHAPTERS_KEY);
  ...
  useEffect(() => {
    try {
      ...
      console.warn("Unable to save dua language:", err);
    }
  }, [language]);
  ...
  useEffect(() => {
    try {
      ...
      console.warn("Unable to save dua favorites:", err);
    }
  }, [favorites]);
  ...
  useEffect(() => {
    try {
      if (lastRead) {
        localStorage.setItem(LAST_READ_DUA_KEY, JSON.stringify(lastRead));
      }
    } catch (err) {
      console.warn("Unable to save last read dua:", err);
    }
  }, [lastRead]);
  ...
  useEffect(() => {
    try {
      localStorage.setItem(VIEWED_CHAPTERS_KEY, JSON.stringify(viewedChapters));
    } catch (err) {
      console.warn("Unable to save viewed chapters:", err);
    }
  }, [viewedChapters]);
  ...
  useEffect(() => {
    ...
    async function loadChapters() {
      try {
        ...
        const data = await getDuaChapters(language);

        if (!cancelled) {
          setChapters(Array.isArray(data) ? data : []);
        }
      } catch (err) {
        console.error("Dua chapters error:", err);

        if (!cancelled) {
          setChapters([]);

          setError(err?.message || "Unable to load dua chapters.");
        }
      } finally {
        if (!cancelled) {
          setLoading(false);
  ...
  useEffect(() => {
    ...
    async function loadFeaturedDua() {
      ...
      try {
        ...
        const result = await getDuasByChapter(firstChapter.id, {
          lang: language,
          page: 1,
          limit: 25,
        });
        ...
        if (!cancelled) {
          setFeaturedDuas(items.filter(Boolean));
        }
      } catch (err) {
        console.error("Featured dua error:", err);
  ...
  useEffect(() => {
    ...
    function handleOutsideClick(event) {
      const languageElement = event.target.closest(".duas-language");
  ...
  async function handleOpenChapter(chapter) {
    ...
    try {
      ...
      const chapterArabic = getChapterArabic(chapter);

      const readData = {
        id: chapter.id,
        title: chapterTitle,
        arabic: chapterArabic,
        category: CATEGORY_NAMES[chapter.category_id] || "Dua Collection",
        timestamp: Date.now(),
      };

      setLastRead(readData);

      setViewedChapters((current) => {
      ...
      const result = await getDuasByChapter(chapter.id, {
        lang: language,
        page: 1,
        limit: 25,
      });
      ...
      const total = Number(
        result?.total ?? result?.meta?.total ?? result?.pagination?.total ?? 0,
      );
      ...
      if (typeof apiHasMore === "boolean") {
        setHasMoreDuas(apiHasMore);
      } else if (total > 0) {
        setHasMoreDuas(items.length < total);
      } else {
        setHasMoreDuas(items.length === 25);
      }
    } catch (err) {
      console.error("Dua detail error:", err);

      setDuaError(err?.message || "Unable to load this dua.");
    } finally {
      setDuaLoading(false);
    }
  }
  ...
  async function handleLoadMoreDuas() {
    if (!selectedChapter || loadingMoreDuas || !hasMoreDuas) {
      return;
    }

    const nextPage = duaPage + 1;

    try {
      setLoadingMoreDuas(true);
      setDuaError("");

      const result = await getDuasByChapter(selectedChapter.id, {
        lang: language,
        page: nextPage,
        limit: 25,
      });
      ...
      if (newItems.length > 0) {
        setDuas((current) => [...current, ...newItems]);
      ...
      if (typeof apiHasMore === "boolean") {
        ...
        setHasMoreDuas(duas.length + newItems.length < total);
      } else {
        setHasMoreDuas(newItems.length === 25);
      }
    } catch (err) {
      console.error("Load more duas error:", err);

      setDuaError(err?.message || "Unable to load more duas.");
    } finally {
  ...
  function handleFavorite(chapterId) {
  ...
  function handleRandomChapter() {
    ...
    handleOpenChapter(randomChapter);
  }
  ...
  const categories = useMemo(() => {
    const ids = chapters
      .map((chapter) => chapter?.category_id)
  ...
  const filteredChapters = useMemo(() => {
    ...
    return chapters.filter((chapter) => {
      const title = getSafeText(getChapterTitle(chapter)).toLowerCase();

      const arabic = getSafeText(getChapterArabic(chapter)).toLowerCase();

      const description = getSafeText(chapter?.description).toLowerCase();
      ...
      const matchesCategory =
        category === "all" || String(chapter?.category_id) === String(category);

      return matchesSearch && matchesCategory;
    });
  }, [chapters, search, category]);
  ...
  }, [loading, search, category, filteredChapters.length, chapters.length]);
        ...
        <section className="duas-header">
          <div className="duas-header__inner">
            <div className="duas-header__content">
              <span className="duas-eyebrow">Daily Supplications</span>

              <h1>Beautiful Duas</h1>

              <p>
                Explore authentic duas for prayer, daily life, travel,
                protection and more.
              </p>
            </div>
        ...
        <section className="duas-content">
          ...
          <div className="duas-controls">
            ...
            <div className="duas-language">
              ...
              >
                <span className="duas-language__globe" aria-hidden="true">
                  🌐
                </span>
            ...
            <div className="duas-search">
              <span className="duas-search__icon" aria-hidden="true">
                ⌕
              </span>
          ...
          {loading && (
            <div className="duas-state duas-state--loading">
              ...
              <p>Please wait while we load the supplications.</p>
            </div>
          )}
          ...
          {!loading && error && (
            <div className="duas-state duas-state--error">
              <div className="duas-state__icon">!</div>

              <h3>Unable to load Duas</h3>
              ...
              <div className="duas-table__body">
                {filteredChapters.map((chapter, index) => (
                  <DuaRow
                    ...
                    chapter={chapter}
                    index={index}
                    isFavorite={favorites.includes(chapter.id)}
            ...
            <div className="duas-modal__panel">
              ...
              <div className="duas-modal__header">
                ...
                <div className="duas-modal__header-content">
                  <span className="duas-modal__eyebrow">Dua Chapter</span>

                  <h2 id="dua-modal-title">
                    {getChapterTitle(selectedChapter)}
                  </h2>

                  {getChapterArabic(selectedChapter) && (
                    <p dir="rtl" className="duas-modal__arabic-title">
                      {getChapterArabic(selectedChapter)}
                    </p>
                  )}

                  <div className="duas-modal__meta">
                    <span>✦ {duas.length} supplications loaded</span>
              ...
              <div className="duas-modal__body" ref={modalBodyRef}>
                {duaLoading && (
                  <div className="duas-modal__state">
                    <div className="duas-spinner" />

                    <p>Loading supplications...</p>
                  </div>
                )}
                ...
                {!duaLoading && duaError && (
                  <div className="duas-modal__state duas-modal__state--error">
                    ...
                    <h3>Unable to load supplications</h3>

                    <p>{duaError}</p>
                  </div>
                )}

                {!duaLoading && !duaError && duas.length === 0 && (
                  <div className="duas-modal__state">
                    <div className="duas-state__icon">◌</div>

                    <h3>No supplications found</h3>

                    <p>There are no duas available in this chapter.</p>
                  </div>
                )}
                  ...
                  <>
                    ...
                    {hasMoreDuas && (
                      <div className="duas-load-more">
                        ...
                        <p>More supplications are available in this chapter.</p>

                        <button
                          type="button"
                          className="duas-load-more__button"
                          onClick={handleLoadMoreDuas}
                          disabled={loadingMoreDuas}
                        >
                          {loadingMoreDuas ? (
                            <>
                    ...
                    {!hasMoreDuas && duas.length > 0 && (
                      <div className="duas-end-message">
                        <span>✦</span>

                        <p>You have reached the end of this chapter.</p>
        ...
        {!loading && !error && chapters.length > 0 && (
          <>
            ...
            <DuaQuickDashboard
              ...
              lastRead={lastRead}
              onContinue={handleOpenChapter}
              onOpenRandom={handleRandomChapter}
            />
            ...
            <DailyDuaFeature duas={featuredDuas} language={language} />
...
========================================================= */}
            ...
            <section className="todays-dua-section">
              <div className="todays-dua-header">
                ...
                <h2>Morning Dua</h2>
                <p>
                  Begin your day with remembrance, gratitude, and a peaceful
                  heart.
                </p>
              </div>

              <div className="todays-dua-card">
                <div className="todays-dua-icon">🌅</div>

                <div className="todays-dua-content">
                  <span className="todays-dua-badge">Morning Dua</span>

                  <h3>Start your morning with Allah's remembrance</h3>
                  ...
                  <p className="todays-dua-description">
                    Begin your morning by remembering Allah and seeking His
                    blessings, guidance, and protection throughout the day.
                  </p>
